...
// PrepareDeployBundle returns a directory to pass to celld deploy. When includeCrons is false,
// a temp copy is made with triggers.crons removed from wrangler; the artifact dir is untouched.
