...
| **Native Wasm research** | [研究纲领](./plans/NATIVE-WASM-RUNTIME-RESEARCH.md) · [R0 审查](./plans/NATIVE-WASM-RUNTIME-REVIEW.md) · [R1 Market Scan](./plans/NATIVE-WASM-RUNTIME-R1.md)（Proposed · R1 desk PASS · 未授权 R2/R3 · 不改变现有 JS 生态） |
