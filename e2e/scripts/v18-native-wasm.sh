...
# Pass/fail bound is the accepted cancellation grace only (intent rev 1); slack is not part of the gate.
CANCEL_SLACK_MS="${NATIVE_E2E_CANCEL_SLACK_MS:-0}"
CANCEL_BOUND_MS="${SAFETY_GRACE_MS}"
