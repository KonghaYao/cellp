...
const deliverPhase = async (phaseName, commitMsg, planDoc, evidenceDir, scope) => {
  ...
  const out = await agent(
    `You are delivering SURGE AD-15 ${phaseName} in ${REPO}.
