...
- **Pinned official corpus:** `@opennextjs/cloudflare@1.14.0` (commit `a644ee1597de577632a29af9a005684554607b2f`) has a real preview harness in `dev/scripts/run-opennext-official-e2e.sh`. The latest measured App Router runtime result is **52 passed / 5 failed / 1 flaky / 3 skipped** out of 58 runnable tests. OpenNext remains **experimental / not tier 1**.
